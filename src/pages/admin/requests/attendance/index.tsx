...
const ManageAttendanceRequests = () => {
  const [data] = useState(fakeData.requests.filter(req => req.type === 'Attendance'))
  ...
  return (
    <>
      <ManageRequestsList
        data={data}
        headerTitle='Attendance Requests'
        openDrawer={!!reqData}
        setOpenDrawer={setReqData}
        drawerTitle='Attendance Requests'
...
export default ManageAttendanceRequests
